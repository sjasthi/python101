...
4. Call `build_instructor_html(students, assignments, COURSE_NAME)` and write it to `/content/python101_all_scores.html`
5. Return the list of all written filepaths
